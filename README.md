...
- [C] Clone your OWN fork of the repository using your terminal.
- [C] CD into the project base directory.
- [C] Download project dependencies by running `npm install`.
- [C] Start up the app using `npm start`.
- [C] Optionally run tests using `npm test`. (The app must be running on `http://localhost:1234`)
